...
/**
 * @title ByzantineMilestoneEscrow
 * @notice Milestone escrow with an application-layer Byzantine-resilient approval committee.
 *
 ...
 */
contract ByzantineMilestoneEscrow {
    string public constant PROJECT_NAME = "Byzantine SmartEscrow";
